    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative w-full max-w-sm bg-bg border border-border rounded-t-2xl p-5">
        ...
        <div className="flex gap-3">
          <button onClick={() => onRate("green")} disabled={loading}
            className="flex-1 py-3 rounded-xl border border-green/40 text-green text-[14px] font-semibold hover:bg-green/10 transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
            <Icon name="check" size={16} />
            Successful
          </button>
          <button onClick={() => onRate("red")} disabled={loading}
            className="flex-1 py-3 rounded-xl border border-red/40 text-red text-[14px] font-semibold hover:bg-red/10 transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
            <Icon name="x" size={16} />
            Not Successful
          </button>
        </div>
